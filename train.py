...
def setup(args):
    ...
    if args.model_type == "ViT-B_16":
        ...
        if args.stage=='train':
            if not args.pretrained_path=="None":
                print("loading pretrained model")
                checkpoint = torch.load(args.pretrained_path, map_location=torch.device('cpu'))
                if 'jx_vit_base_p16_224-80ecf9dd.pth' in args.pretrained_path:
    ...
    while True:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if global_step % (5*len_train) == 0 and args.local_rank in [-1, 0]:
                    ...
                    if best_auc < auroc_avg:
                        save_model_auc(args, model, global_step)
                        best_auc = auroc_avg
...
def main():
    ...
    parser.add_argument("--pretrained_path", type=str, default="/home/local/PARTNERS/cu210/imagetext/Algorithm/mmsegmentation/CMAE4.pth", help='Path of pretrained model')
    parser.add_argument("--output_dir", default="./result", type=str, help="path to save model")
    ...
    parser.add_argument("--dataset_path", default="/home/local/PARTNERS/cu210/data_folder/cchen/bpm/phase3_ge_origin/img_proc", type=str, help='Path of preprocessed data')
    ...
    parser.add_argument("--name", default="bpm", help="Name of this run. Used for monitoring.")
    ...
    parser.add_argument("--train_batch_size", default=96, type=int, help="Total batch size for training.")
